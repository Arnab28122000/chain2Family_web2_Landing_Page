...
export default function CoinScreen() {
    ...
    backgroundColor="#08183A" 
      ...
      justify="center" align="center" paddingTop="800px">
          <Text alignSelf='center' textAlign="center" width="100vw" fontSize="22px" wordSpacing="7px" color="white" lineHeight="40px" paddingRight="70px" paddingLeft="70px" fontWeight="bold">
